...
namespace llvm
{
  /// Disables ::llvm::simplify_type for sprite::llvm::object.
  template<typename T, template<typename> class Object>
  struct simplify_type<Object<T>>
    : std::enable_if<
          std::is_base_of<sprite::llvm::object<T>, Object<T>>::value
            || std::is_base_of<sprite::llvm::aux::arg_with_flags<T>, Object<T>>::value
        , sprite::llvm::null_arg
        >::type
  { typedef sprite::llvm::null_arg SimpleType; };

  /// Disables ::llvm::cast_retty for sprite::llvm::object.
  template<
      class To, class From
  ...
  struct cast_retty<To, Object<From>>
    : std::enable_if<
          std::is_base_of<sprite::llvm::object<From>, Object<From>>::value
            || std::is_base_of<sprite::llvm::aux::arg_with_flags<From>, Object<From>>::value
        , sprite::llvm::null_arg
        >::type
  {};
}
...
namespace sprite { namespace llvm
{
  ...
  #define SPRITE_CAST_RETURN                                             \
      typename std::enable_if<                                           \
          std::is_base_of<sprite::llvm::object<Src>, Object<Src>>::value \
