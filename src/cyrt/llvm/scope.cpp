...
#include "cyrt/llvm/global.hpp"
#include "cyrt/llvm/label.hpp"
#include "cyrt/llvm/metadata.hpp"
#endif
...
namespace
{
   ...
   *
   * If the block has a terminator tagged with cyrt.implied metadata, then
