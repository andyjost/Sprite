...
class PreludeSpecification(generic_prelude.PreludeSpecification):
  ...
  FUNCTION_METADATA = {
    ...
    , 'prim_divInt'           : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_eqChar'           : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_eqFloat'          : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_eqInt'            : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_ltEqChar'         : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_ltEqFloat'        : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_ltEqInt'          : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_minusInt'         : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_modInt'           : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_negateFloat'      : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_plusInt'          : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_quotInt'          : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_readFileContents' : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_remInt'           : {'cxx.symbolname': 'cyrt::notused_Info'          }
    , 'prim_timesInt'         : {'cxx.symbolname': 'cyrt::notused_Info'          }
