...
class PreludeSpecification(generic_prelude.PreludeSpecification):
  ...
  CONSTRUCTOR_METADATA = {
      ('_Failure'   , 0)  : {'cxx.symbolname': 'Fail_Info'                }
    , ('_Constraint', 0)  : {'cxx.symbolname': 'StrictConstraint_Info'    }
    , ('_Constraint', 1)  : {'cxx.symbolname': 'NonStrictConstraint_Info' }
    , ('_Constraint', 2)  : {'cxx.symbolname': 'ValueBinding_Info'        }
    , ('_PartApplic', 0)  : {'cxx.symbolname': 'PartApplic_Info'          }
    , ('_Free'      , 0)  : {'cxx.symbolname': 'Free_Info'                }
    , ('_Fwd'       , 0)  : {'cxx.symbolname': 'Fwd_Info'                 }
    , ('Int'        , 0)  : {'cxx.symbolname': 'Int_Info'                 }
    , ('Float'      , 0)  : {'cxx.symbolname': 'Float_Info'               }
    , ('Char'       , 0)  : {'cxx.symbolname': 'Char_Info'                }
    , ('[]'         , 0)  : {'cxx.symbolname': 'Cons_Info'                }
    , ('[]'         , 1)  : {'cxx.symbolname': 'Nil_Info'                 }
    , ('()'         , 0)  : {'cxx.symbolname': 'Unit_Info'                }
    , ('_Choice'    , 0)  : {'cxx.symbolname': 'Choice_Info'              }
    , ('Bool'       , 0)  : {'cxx.symbolname': 'False_Info'               }
    , ('Bool'       , 1)  : {'cxx.symbolname': 'True_Info'                }
    , ('IO'         , 0)  : {'cxx.symbolname': 'IO_Info'                  }
    , ('(,)'        , 0)  : {'cxx.symbolname': 'Pair_Info'                }
    }
