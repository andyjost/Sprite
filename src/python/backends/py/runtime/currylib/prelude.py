...
_functions_ = [
  ...
  , _F('modInt'                , 2, metadata={'py.unboxedfunc': lambda x, y: x - y * op.floordiv(x,y)         })
  ...
  , _F('prim_chr'              , 1, metadata={'py.unboxedfunc': (chr, 'Int', 'Char')    })
  ...
  , _F('prim_truncateFloat'    , 1, metadata={'py.unboxedfunc': (int, 'Float', 'Int')   })
  ...
  , _F('quotInt'               , 2, metadata={'py.unboxedfunc': lambda x, y: int(op.truediv(x, y))            })
  , _F('remInt'                , 2, metadata={'py.unboxedfunc': lambda x, y: x - y * int(op.truediv(x, y))    })
