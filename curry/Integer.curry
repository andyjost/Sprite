...
bindint :: Int -> Int -> Bool
bindint a b | x =:= toAlgebraicInt b = a =:<= fromAlgebraicInt x where x free

narrowInt :: Int -> [Int] -> Int
narrowInt a bs | a =:= (anyOf bs) = a

narrowEqInt :: Int -> Int -> Bool
narrowEqInt x a = x =:<= fromAlgebraicInt z &> z == toAlgebraicInt a where z free

narrowLtEqInt :: Int -> Int -> Bool
narrowLtEqInt x a = x =:<= fromAlgebraicInt z &> lteqInteger z (toAlgebraicInt a) where z free

narrowPlusInt :: Int -> Int -> Int
narrowPlusInt x a = x =:<= fromAlgebraicInt z &> fromAlgebraicInt (z +# (toAlgebraicInt a)) where z free

narrowMinusInt :: Int -> Int -> Int
narrowMinusInt x a = x =:<= fromAlgebraicInt z &> fromAlgebraicInt (z -# (toAlgebraicInt a)) where z free
narrowMinusIntRev :: Int -> Int -> Int
narrowMinusIntRev a x = x =:<= fromAlgebraicInt z &> fromAlgebraicInt ((toAlgebraicInt a) -# z) where z free

narrowTimesInt :: Int -> Int -> Int
narrowTimesInt x a = x =:<= fromAlgebraicInt z &> fromAlgebraicInt (z *# (toAlgebraicInt a)) where z free

narrowDivInt :: Int -> Int -> Int
narrowDivInt x a = x =:<= fromAlgebraicInt z &> fromAlgebraicInt (divInteger z (toAlgebraicInt a)) where z free
narrowDivIntRev :: Int -> Int -> Int
narrowDivIntRev a x = x =:<= fromAlgebraicInt z &> fromAlgebraicInt (divInteger (toAlgebraicInt a) z) where z free

narrowModInt :: Int -> Int -> Int
narrowModInt x a = x =:<= fromAlgebraicInt z &> fromAlgebraicInt (modInteger z (toAlgebraicInt a)) where z free
narrowModIntRev :: Int -> Int -> Int
narrowModIntRev a x = x =:<= fromAlgebraicInt z &> fromAlgebraicInt (modInteger (toAlgebraicInt a) z) where z free

narrowQuotInt :: Int -> Int -> Int
narrowQuotInt x a = x =:<= fromAlgebraicInt z &> fromAlgebraicInt (quotInteger z (toAlgebraicInt a)) where z free
narrowQuotIntRev :: Int -> Int -> Int
narrowQuotIntRev a x = x =:<= fromAlgebraicInt z &> fromAlgebraicInt (quotInteger (toAlgebraicInt a) z) where z free

narrowRemInt :: Int -> Int -> Int
narrowRemInt x a = x =:<= fromAlgebraicInt z &> fromAlgebraicInt (remInteger z (toAlgebraicInt a)) where z free
narrowRemIntRev :: Int -> Int -> Int
narrowRemIntRev a x = x =:<= fromAlgebraicInt z &> fromAlgebraicInt (remInteger (toAlgebraicInt a) z) where z free
