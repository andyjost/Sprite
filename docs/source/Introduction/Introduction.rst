...
aspects of Logic Programming more paletable to more potential users.
...
more user-friendly by cleverly leveraging Haskell, with its well-developed
community and resources.  One can learn much of Curry by reading a Haskell
tutorial.  And one can write a mostly functional program that judiciously uses
logic features only where they make sense.
